...
total_stories: 117
total_waves: 73
total_points: 722  # = 719 pre-v3.43 +3 STORY-164 (wave-TBD draft, E-11, 3 pts); wave-table scheduled: 697 (unchanged); epic-table grand total: 722; stories: 117; waves: 73
...
| STORY-164 | Wave-73 cycle-closing: status-vocabulary legend, citation preflight validator, changelog-gate content assertion, guidance-doc reference row | E-11 | ~ | 3 | draft | — |
...
- Total points: **722** (v3.43: STORY-164 added wave-TBD, +3 pts; wave-table scheduled row **697** (unchanged); excl. STORY-091+STORY-121+STORY-143+STORY-147+STORY-148+STORY-155+STORY-164 wave-TBD/superseded; epic table shows 722)
  > **Point-scope key (two counts — frontmatter/epic-table at 722, wave-table at 697):** (1) `total_points: 722` in frontmatter = all 110 scheduled product stories (697 pts) + STORY-091 tooling (5 pts) + STORY-121 tooling (3 pts) + STORY-143 (3 pts) + STORY-147 (3 pts) + STORY-148 (5 pts, superseded) + STORY-155 (3 pts) + STORY-164 (3 pts). (2) Wave-table "TOTAL" row = **697** = 110 scheduled product stories (STORY-149 wave 70 + STORY-150/156/157 wave 71 + STORY-158/159/160/161 wave 72 + STORY-162/STORY-163 wave 73 now included); excludes STORY-091, STORY-121, STORY-143, STORY-147, STORY-148, STORY-155, STORY-164 (wave-TBD or superseded). (3) Epic-table "TOTAL" row = **722** = all 117 stories including all wave-TBD/superseded. Frontmatter and epic-table agree at 722; wave-table differs because it excludes wave-TBD/superseded stories.
