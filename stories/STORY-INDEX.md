...
total_stories: 132
total_waves: 83
total_points: 776  # = 776 (+3 STORY-166 wave-TBD +11 STORY-175..179 wave-TBD/superseded); wave-table scheduled: 740 (STORY-166+STORY-175..179 wave-TBD/superseded excluded; incl. STORY-167..174 waves 76-83); epic-table grand total: 776 (STORY-176 re-scoped 3→2 pts 2026-07-19; v3.78)
...
# v3.78 (2026-07-19): E-11 upstream re-scope burst: STORY-175/177/178/179 status draft→superseded (all ACs engine-level; drbothen/vsdd-factory#494/#461/#655/#305/#396; #457/#637 confirmed duplicates; STORY-178 AC-178-003+AC-178-004 absorbed by STORY-176). STORY-176 re-scoped v1.0→v2.0: local gate + tooling hygiene survivor (AC-176-001 ci.yml skeleton/seam extension + AC-176-002 input-hash re-baseline + AC-176-003 .gitignore mutants.out*; pts 3→2). E-11 pts 68→67; total_points 777→776. STORY-166 classification: product-local (AC-166-001 bin/validate-citations Python extension + AC-166-003 demo-evidence scrub doc; stays in wirerust).
...
| STORY-166 | Wave-75 cycle-closing: citation symbol-at-line assertion, demo-evidence scrub scope extension (project half) | E-11 | ~ | 3 | draft | — |
| STORY-175 | Feature-IEC104 Cycle-Close: Demo Evidence JSON Accuracy Protocol | E-11 | ~ | 2 | superseded | — |
| STORY-176 | Feature-IEC104 Cycle-Close: Local Gate + Tooling Hygiene Sweeps | E-11 | ~ | 2 | draft | — |
...
| 82 | STORY-173 | 1 | 5 |
| 83 | STORY-174 | 1 | 5 |
| **TOTAL (excl. STORY-091 wave-TBD, STORY-121 wave-TBD, STORY-143 wave-TBD, STORY-147 wave-TBD, STORY-148 superseded, STORY-155 wave-TBD, STORY-166 wave-TBD, STORY-175 superseded, STORY-176 wave-TBD, STORY-177 superseded, STORY-178 superseded, STORY-179 superseded)** | | **120** | **740** |
