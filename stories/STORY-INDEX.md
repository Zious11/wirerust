...
total_stories: 100
total_waves: 66
total_points: 641  # = 638 pre-STORY-147 + 3 (STORY-147); wave-table scheduled: 630 (STORY-091+STORY-121+STORY-143+STORY-147 wave-TBD excluded); epic-table grand total: 644; stories: 99+1=100; waves: 66 (unchanged)
# ARITHMETIC: STORY-147=3 pts (E-11 process-gap, wave TBD); total_points: 638+3=641; wave-table scheduled: 630 (unchanged, STORY-147 wave-TBD excluded); epic-table: 641+3=644; total_stories: 99+1=100; total_waves: 66 (unchanged).
...
| **TOTAL (excl. STORY-091 wave-TBD, STORY-121 wave-TBD, STORY-143 wave-TBD, STORY-147 wave-TBD)** | | **96** | **630** |
...
| E-11: Tooling and Self-Improvement — **STORY-143 release-changelog hardening added (D-301, 2026-06-29); STORY-147 mutation-testing parallelism hardening added (PG-MUTANTS-JOBS-001, fix-tls-clienthello-frag F6, 2026-07-01)** | STORY-091, STORY-121, STORY-143, STORY-147 | 4 | 14 |
...
- Total points: **641** (638 pre-STORY-147 + 3 STORY-147; wave-table scheduled row shows 630 — excl. STORY-091+STORY-121+STORY-143+STORY-147 wave-TBD; epic table shows 644)
  > **Point-scope key (three counts, none wrong):** (1) `total_points: 641` in frontmatter = all 96 scheduled product stories (630 pts) + STORY-091 tooling (5 pts) + STORY-143 (3 pts) + STORY-147 (3 pts); excludes STORY-121 (wave-TBD, 3 pts). (2) Wave-table "TOTAL" row = **630** = the 96 scheduled product stories only; excludes STORY-091, STORY-121, STORY-143, and STORY-147 (all wave-TBD). (3) Epic-table "TOTAL" row = **644** = all 100 stories including STORY-091 (5 pts) + STORY-121 (3 pts) + STORY-143 (3 pts) + STORY-147 (3 pts). The three counts differ solely by which wave-TBD tooling stories are included.
- Graph is acyclic: **Yes** (Kahn topological sort verified; Feature-#7 dependency chain: STORY-100 → {STORY-101 ∥ STORY-102} → STORY-103 → STORY-104 → STORY-105; Feature-#8 DNP3 chain: STORY-100 → STORY-106 → STORY-107 → STORY-108 → STORY-109 → STORY-110; Feature-#9 ARP chain: STORY-110 → STORY-111 → STORY-112 → STORY-113 → STORY-114 → STORY-115; E-17 hardening chain: STORY-115 → STORY-116 → STORY-117; E-18/E-8 collapse chain: STORY-118 (no predecessor) → STORY-120 (no predecessor) → STORY-122 (wave 49) → STORY-119/B (wave 50); E-19 pcapng chain: STORY-123 (no predecessor) → STORY-124 → {STORY-125 ∥ STORY-126} → STORY-127 → STORY-128; STORY-129 (depends_on=[], wave 57, isolated vertex); E-20 ENIP chain: {STORY-130 ∥ STORY-131} (wave 58, no deps) → {STORY-132 (dep=130) ∥ STORY-133 (dep=131)} (wave 59) → {STORY-134 ∥ STORY-135 ∥ STORY-136 ∥ STORY-137} (dep=132+133, wave 60) → STORY-138 (dep=134+135+136+137, wave 61) → STORY-139 (dep=STORY-138, wave 62) → STORY-140 (dep=STORY-139, wave 63) → STORY-142 (dep=STORY-140, wave 64); STORY-141 (dep=[], wave 64, isolated vertex — Modbus on develop, no predecessor needed); fix-tls-clienthello-frag TLS carry chain: STORY-144 (dep=[], wave 65, isolated vertex — TLS carry struct + ClientHello path) → {STORY-145 (dep=STORY-144, wave 66, ServerHello symmetry + isolation) ∥ STORY-146 (dep=STORY-144, wave 66, buffer-saturation telemetry — dep re-pointed to STORY-144 per I6; parallel with STORY-145)}; no back-edges into existing graph; acyclicity confirmed: 100 = 96 product stories + STORY-091 tooling + STORY-121 tooling + STORY-143 tooling + STORY-147 tooling)
- All 10 product epics + E-11 (Tooling, 4 stories: STORY-091 + STORY-121 + STORY-143 + STORY-147) + E-12 (Pcap Timestamps) + E-13 (Multi-Tag Migration) + E-14 (Modbus) + E-15 (DNP3) + E-16 (ARP) + E-17 (ARP QinQ/MACsec Hardening) + E-18 (Terminal Finding-Collapse) + E-19 (pcapng Capture-Format Reader Support) + E-20 (EtherNet/IP ENIP/CIP Analyzer) + E-5 extended (TLS carry-buffer reassembly, STORY-144/145/146) covered: **Yes**
