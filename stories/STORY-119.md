...
|----|---------|--------------------------|
| BC-2.11.013 | v1.12 | Invariant 4: "Collapse within grouped/`--mitre` mode is deferred to STORY-119 (future cycle)" |
| BC-2.11.025 | v1.9 | Invariant 5: "Grouped-mode collapse is deferred to a future cycle (see STORY-119)" |
| BC-2.11.026 | v1.10 | Postcondition 4: "The grouped/`--mitre` path MUST NOT emit a ` (xN)` suffix on any finding, regardless of group size (BC-2.11.013 Invariant 4)" |
