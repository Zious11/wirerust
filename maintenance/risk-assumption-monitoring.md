...
| MEDIUM | REC-004 | R-CAND-010 (SEC-001 unsafe split-borrow in enip.rs): refactor to safe `get_disjoint`/index pattern. v0.12.0 candidate (tech-debt-register SEC-001 OPEN). | S | Carry forward P2 |
