...
| proptest | 12 | VP-006, VP-010, VP-011, VP-012, VP-013, VP-014, VP-021, VP-029, VP-030, VP-031, VP-033, VP-034 |
...
- VP-INDEX total (34) must equal verification-architecture.md row count (34)
- VP-INDEX total (34) must equal verification-coverage-matrix.md VP row count (34)
- verification-coverage-matrix.md Totals row: Kani(15) + proptest(12) + fuzz(2) + integration/unit(5) = 34
- P0 count (8) + P1 count (20) + test-sufficient (6) = 34; draft count 3 (VP-032, VP-033, VP-034); active 0; verified 31
