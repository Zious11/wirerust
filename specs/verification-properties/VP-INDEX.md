...
| VP-027 | pcapng EPB Parse Safety, interface_id Bounds, and Padding-Overrun Classification | reader.rs (pcapng_pure_core fns) [b] | Kani | P1 | draft | BC-2.01.012 |
...
| VP-031 | pcapng SPB Captured-Len Computation Correctness (snaplen-free) | reader.rs (pcapng_pure_core fns) [b] | proptest | P1 | draft | BC-2.01.013 |
...
- VP-027: pcapng EPB parse safety, interface_id bounds (guard-before-allocate), and padding-overrun/bound-by-body → Err(E-INP-008) [NEW — SS-01 pcapng, ADR-009 rev 4; amended rev 8 / C-1]
...
- VP-031: pcapng SPB captured-len computation correctness (snaplen-free) — proptest arithmetic invariant for min(original_len, body.len() as u32) (snaplen DROPPED per Decision 9 rev 8; fills SPB framing VP gap per DF-CANONICAL-FRAME-HOLDOUT-001) [NEW — SS-01 pcapng, ADR-009 rev 6; amended rev 8 / Decision 9]
...
> rev 4/5/6/7/8 PO BC-Change Dispatch) and F3 story decomposition. They will transition
> to verified at F6 hardening per the standard lifecycle (VP-022/023/024 pattern).
