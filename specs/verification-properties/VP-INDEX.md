...
- VP-INDEX total (32) must equal verification-architecture.md row count (32)
- VP-INDEX total (32) must equal verification-coverage-matrix.md VP row count (32)
- verification-coverage-matrix.md Totals row: Kani(15) + proptest(10) + fuzz(2) + integration/unit(5) = 32
- P0 count (8) + P1 count (18) + test-sufficient (6) = 32; draft count 1 (VP-032); active 0; verified 31
