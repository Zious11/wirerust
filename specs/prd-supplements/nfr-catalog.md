...
| NFR-RES-015 | Resource | TLS per-direction record-assembly buffer cap: `MAX_BUF = 65,536` bytes | No OOM on large TLS record stream | (No direct test -- BC-TLS-005 P1 planned) | P1 | N/A | N/A -- tls.rs:29 (`const MAX_BUF: usize = 65_536`); cap enforced via `saturating_sub` in `on_data` at tls.rs:761, 768 (v1.2 cited 733, 740 -- stale line refs; mechanism confirmed at 761, 768) |
