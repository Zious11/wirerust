...
| NFR-OBS-008 | Observability | `--mitre` flag groups findings under tactic headers in kill-chain order; `Uncategorized` bucket last | 16 tactic headers + Uncategorized; stable order per `all_tactics_in_report_order` | Tests: `mitre_grouping_*` (BC-RPT-013..017) | P0 | N/A | N/A -- src/reporter/terminal.rs:260-304 (`render_findings_grouped`) |
