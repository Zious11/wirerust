...
|--------|----------|-------------|
| VP-TBD | Second FIN (any direction) closes flow | unit: process FIN from C, FIN from S; assert flow removed |
| VP-TBD | CloseReason::Fin delivered to handler | unit: capture on_flow_close reason |
