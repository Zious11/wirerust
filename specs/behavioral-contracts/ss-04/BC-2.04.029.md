...
|--------|----------|-------------|
| VP-TBD | close_flow for missing key never panics | manual: debug_assert is not panic in release mode |
| VP-TBD | flows unchanged after missing-key close_flow call | manual/unit |
...
| Architecture Module | SS-04 (reassembly/lifecycle.rs:42-50, C-6) |
| Stories | S-TBD |
