...
|--------|----------|-------------|
| VP-TBD | SYN sets initiator and ISN in ClientToServer direction | unit: construct SYN packet; assert flow state post-process |
| VP-TBD | Retransmitted SYN does not change ISN or initiator | unit: process two SYNs; assert values unchanged |
