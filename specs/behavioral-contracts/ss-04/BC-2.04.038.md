...
|--------|----------|-------------|
| VP-TBD | Multi-segment full coverage with matching bytes returns Duplicate | unit: test_multi_segment_full_coverage_returns_duplicate |
| VP-TBD | Multi-segment full coverage with conflicting bytes returns ConflictingOverlap | unit: test_multi_segment_full_coverage_conflicting_returns_conflict |
