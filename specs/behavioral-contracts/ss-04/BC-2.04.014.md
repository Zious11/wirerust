...
| Property | Value |
|----------|-------|
| **Path** | `src/reassembly/mod.rs:375-376` |
| **Confidence** | high |
...
| 1.4 | 2026-06-01 | product-owner | DF-SIBLING-SWEEP-001 HS-043 re-anchor: mod.rs:337-340 → mod.rs:375-376 (total_memory += bytes_added); mod.rs:525-527 → mod.rs:585 (total_memory -= flushed bytes). |
