...
modified:
  ...
  - "v1.3: DF-SIBLING-SWEEP-001 HS-043 re-anchor: mod.rs:620-658 → mod.rs:735-773 (summarize fn); LESSON-P2.09 doc comment at mod.rs:618 → mod.rs:731-734. — 2026-06-01"
  - "v1.4: PG-ARP-F2-007 ss-04-full re-anchor: mod.rs:735-773 → mod.rs:735-773 (summarize fn); mod.rs:731-734 → mod.rs:731-734 (LESSON-P2.09 doc comment). — 2026-06-13"
deprecated: null
deprecated_by: null
replacement: null
retired: null
...
| Architecture Module | SS-04 (reassembly/mod.rs:735-773, C-6) |
| Stories | STORY-012 |
...
- `src/reassembly/mod.rs:735-773` -- summarize() implementation
...
| Property | Value |
|----------|-------|
| **Path** | `src/reassembly/mod.rs:735-773` |
| **Confidence** | high |
...
- **documentation**: LESSON-P2.09 doc comment at mod.rs:731-734 explains BTreeMap ordering rationale
