...
|--------|----------|-------------|
| VP-TBD | Inserted result: segment stored at correct offset key | unit: test_insert_single_segment |
| VP-TBD | buffered_bytes == segment data length after single insert | unit: test_buffered_bytes_after_insert |
| VP-TBD | Empty data returns Inserted without any BTreeMap mutation | unit |
