...
modified:
  ...
  - "v1.4: DF-SIBLING-SWEEP-001 HS-043 re-anchor: mod.rs:265-271 → mod.rs:297-302 (SYN+ACK block in apply_handshake_flags). — 2026-06-01"
  - "v1.5: PG-ARP-F2-007 ss-04-full re-anchor: mod.rs:297-302 → mod.rs:297-302 (SYN+ACK block in apply_handshake_flags). — 2026-06-13"
deprecated: null
deprecated_by: null
replacement: null
retired: null
...
| Architecture Module | SS-04 (reassembly/mod.rs:297-302, apply_handshake_flags; flow.rs:242-246) |
| Stories | STORY-013 |
...
- `src/reassembly/mod.rs:297-302` -- SYN+ACK block in apply_handshake_flags
...
| Property | Value |
|----------|-------|
| **Path** | `src/reassembly/mod.rs:297-302` |
| **Confidence** | high |
