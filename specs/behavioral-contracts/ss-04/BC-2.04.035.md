...
|--------|----------|-------------|
| VP-TBD | Duplicate: buffered_bytes unchanged | unit: test_retransmission_dedup |
| VP-TBD | Duplicate: segments unchanged (no new keys) | unit |
| VP-TBD | overlap_count incremented even on Duplicate | unit: verify overlap_count after retransmission |
