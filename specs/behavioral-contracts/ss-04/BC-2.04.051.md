...
|--------|----------|-------------|
| VP-TBD | on_rst() transitions to Closed from any state | unit: test_flow_rst_from_any_state |
| VP-TBD | RST closes flow with CloseReason::Rst | unit: test_rst_closes_flow |
