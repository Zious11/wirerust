...
modified:
  ...
  - "v1.4: DF-SIBLING-SWEEP-001 HS-043 re-anchor: mod.rs:273-279 → mod.rs:305-310 (RST block in apply_handshake_flags). — 2026-06-01"
  - "v1.5: PG-ARP-F2-007 ss-04-full re-anchor: mod.rs:305-310 → mod.rs:305-310 (RST block in apply_handshake_flags). — 2026-06-13"
deprecated: null
deprecated_by: null
replacement: null
retired: null
...
| Architecture Module | SS-04 (reassembly/flow.rs:264-266, C-7; reassembly/mod.rs:305-310, C-6) |
| Stories | STORY-013 |
...
- `src/reassembly/mod.rs:305-310` -- engine RST handling calling on_rst and close_flow
