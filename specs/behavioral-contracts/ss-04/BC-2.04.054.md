...
|--------|----------|-------------|
| VP-TBD | findings.len() <= MAX_FINDINGS + 1 after finalize (not MAX_FINDINGS + 2) | unit |
| VP-TBD | finalize is idempotent (second call produces no additional findings) | unit: test_finalize_flushes_remaining |
