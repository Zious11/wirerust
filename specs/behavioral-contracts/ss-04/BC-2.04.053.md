...
|--------|----------|-------------|
| VP-TBD | direction == ClientToServer iff src matches initiator | unit: test_flow_direction_determines_client_server |
| VP-TBD | initiator=None returns ServerToClient | unit |
