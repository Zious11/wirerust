...
modified:
  ...
  - "v1.4: DF-SIBLING-SWEEP-001 HS-043 re-anchor: mod.rs:225-235 → mod.rs:250-273 (get_or_create_flow fn). — 2026-06-01"
  - "v1.7: PG-ARP-F2-007 ss-04-full re-anchor: mod.rs:250-273 → mod.rs:250-273 (get_or_create_flow); lifecycle.rs:73-98 → lifecycle.rs:73-98 (evict_flows). — 2026-06-13"
deprecated: null
deprecated_by: null
replacement: null
retired: null
...
| Architecture Module | SS-04 (reassembly/mod.rs:250-273, get_or_create_flow; lifecycle.rs:73-98, evict_flows) |
| Stories | STORY-020 |
...
- `src/reassembly/mod.rs:250-273` -- get_or_create_flow: max_flows check + evict_flows call
- `src/reassembly/lifecycle.rs:73-98` -- evict_flows: sort + close loop

## Source Evidence

| Property | Value |
|----------|-------|
| **Path** | `src/reassembly/lifecycle.rs:73-98` |
| **Confidence** | high |
