...
|--------|----------|-------------|
| VP-TBD | Non-Established evicted before Established | unit: mix of flow states at max_flows; verify eviction order |
| VP-TBD | Oldest (lowest last_seen) evicted within each group | unit |
