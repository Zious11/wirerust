...
|--------|----------|-------------|
| VP-TBD | PartialOverlap: existing bytes unchanged at overlap positions | unit: test_overlap_first_wins |
| VP-TBD | PartialOverlap: buffered_bytes increases by exactly gap bytes count | unit: test_buffered_bytes_after_overlap |
| VP-TBD | overlap_count increments by 1 per partial overlap event | unit |
