...
|--------|----------|-------------|
| VP-TBD | Flows past timeout are closed | unit: create flow, expire with past timeout |
| VP-TBD | Non-expired flows survive | unit: expire; assert surviving flows count |
