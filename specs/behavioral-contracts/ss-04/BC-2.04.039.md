...
|--------|----------|-------------|
| VP-TBD | seq.wrapping_sub(isn) produces correct monotonic offset across u32::MAX boundary | unit: test_sequence_wraparound |
| VP-TBD | flush_contiguous delivers wrapped segments in correct byte order | unit: test_sequence_wraparound |
...
| Architecture Module | SS-04 (reassembly/segment.rs:32-34, C-8) |
| Stories | S-TBD |
...
- `src/reassembly/segment.rs:32-34` -- seq_offset function: `seq.wrapping_sub(isn) as u64`

## Source Evidence

| Property | Value |
|----------|-------|
| **Path** | `src/reassembly/segment.rs:32-34` |
| **Confidence** | high |
