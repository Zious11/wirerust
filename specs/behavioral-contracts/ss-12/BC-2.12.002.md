...
|--------|----------|-------------|
| VP-TBD | summary subcommand parses targets and --hosts | unit: test_summary_subcommand |
...
| Capability Anchor Justification | CAP-11 ("Reporting and Output") per capabilities.md §CAP-11 -- the summary subcommand is the triage-only reporting path; its --hosts flag controls the expanded host breakdown in the terminal output |
