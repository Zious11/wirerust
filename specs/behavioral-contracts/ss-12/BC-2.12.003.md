...
|--------|----------|-------------|
| VP-TBD | --no-color flag sets no_color=true | unit: test_no_color_flag |
...
| Capability Anchor Justification | CAP-11 ("Reporting and Output") per capabilities.md §CAP-11 -- color control is part of the terminal output configuration in the reporting capability |
