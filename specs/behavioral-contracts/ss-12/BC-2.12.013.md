...
|--------|----------|-------------|
| VP-TBD | Progress bar does not appear in stdout/final output | manual / visual (LOW confidence -- cosmetic UI, no assertion) |
...
| Capability Anchor Justification | CAP-11 ("Reporting and Output") per capabilities.md §CAP-11 -- the progress bar is a UX output feature of the analysis pipeline |
