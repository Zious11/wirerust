...
|--------|----------|-------------|
| VP-TBD | total_packets and hosts incremented correctly | unit: test_summary_host_counting |
| VP-TBD | protocol counters incremented | unit: test_summary_protocol_breakdown |
