...
| BC-2.01.009 | Accept pcapng Format: Transparent Detection via Magic-Byte Probe | P0 | [WRITTEN] | feature-pcapng-F2 | <!-- v1.3: supersedes BC-2.01.004; greenfield; ADR-009 Decision 5/6; STORY-123; v1.1: PC1 over-promise fixed — empty pcapng valid (>=0 packets); H5-1 FIXED; v1.2: C-4 stale error-code sweep — E-INP-008..E-INP-013 added; v1.3: M-1 traceability path corrected — .factory/holdout-scenarios/ (not .factory/specs/holdout-scenarios/) -->
| BC-2.01.010 | Parse pcapng Section Header Block (SHB): Byte-Order Detection and Version | P0 | [WRITTEN] | feature-pcapng-F2 | <!-- v1.8: greenfield; ADR-009 Decision 1/2; STORY-123; v1.1: F-06 reject AC; v1.2: rationale corrected; v1.3: no-panic AC; v1.4: saturating ts arithmetic, VP-026; v1.5: BOM-1 circular phrasing removed; v1.6: BOM 9-statement sweep; v1.7: VP re-anchor, Kani unwind note, E-INP-008/010 boundary; v1.8: H-1 E-INP-008 narrowed to semantic failures only (invalid BOM / major!=1) — SHB framing truncation routes to E-INP-010; H-2 constructible-fixture window for IDB 12<=btl<20 stated -->
| BC-2.01.011 | Parse pcapng Interface Description Block (IDB): Link Type and Timestamp Resolution | P0 | [WRITTEN] | feature-pcapng-F2 | <!-- v1.3: greenfield; ADR-009 Decision 2/3/4; STORY-124; v1.1: if_tsresol clarified, VP-025 note; v1.2: zero-packet one-shot notice, E-INP-013 cite; v1.3: H-2 constructible-fixture window 12<=btl<20 explicit; H-5 per-SHB reset dead-spec deferred (Decision 16) -->
| BC-2.01.012 | Parse pcapng Enhanced Packet Block (EPB): Packet Data and Timestamp | P0 | [WRITTEN] | feature-pcapng-F2 | <!-- v1.3: greenfield; ADR-009 Decision 2/4; STORY-125; v1.1: EPB_FIXED_OVERHEAD_BYTES=28, guard-before-allocate, VP-027; v1.2: boundary I-9 clarification; v1.3: H-5 dead-spec removed (per-SHB reset deferred Decision 16); O-1 PC5 interface_id re-cite corrected -->
| BC-2.01.013 | Parse pcapng Simple Packet Block (SPB): Packet Data Without Timestamp | P1 | [WRITTEN] | feature-pcapng-F2 | <!-- v1.3: greenfield; ADR-009 Decision 2; STORY-126; v1.1: SPB overhead 16 bytes, no-panic AC; v1.2: 16-byte bound re-stated, HS-107 authored; v1.3: C-1 SPB three-way min(original_len, snaplen, block_body_available) panic fix propagated to PC1+AC-002+EC-007+Case-B; VP-031 assigned (proptest arithmetic correctness) -->
| BC-2.01.014 | Pure-Core 64-bit pcapng Timestamp Normalization to (ts_sec, ts_usecs) | P0 | [WRITTEN] | feature-pcapng-F2 | <!-- v1.3: greenfield; ADR-009 Decision 4; VP-025 Kani target; STORY-125; v1.1: saturating arithmetic, VP-025; v1.2: Kani unwind note, base-10 table note; v1.3: M-4 classic-pcap parity scoped to ts_high==0 (ts_high>0 saturates; classic stores raw u32 secs — not bitshift equivalent) -->
