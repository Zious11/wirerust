...
| BC-2.01.010 | Parse pcapng Section Header Block (SHB): Byte-Order Detection and Version | P0 | [WRITTEN] | feature-pcapng-F2 | <!-- v1.9: greenfield; ADR-009 Decision 1/2; STORY-123; v1.1: F-06 reject AC; v1.2: rationale corrected; v1.3: no-panic AC; v1.4: saturating ts arithmetic, VP-026; v1.5: BOM-1 circular phrasing removed; v1.6: BOM 9-statement sweep; v1.7: VP re-anchor, Kani unwind note, E-INP-008/010 boundary; v1.8: H-1 E-INP-008 narrowed to semantic failures only (invalid BOM / major!=1); v1.9: H-1 Decision 20 uniform body-decode-truncation rule — SHB body-too-short (btl=16 → body=4 < 16-byte minimum) re-added as constructible E-INP-008 case, correcting pass-3 over-narrowing -->
