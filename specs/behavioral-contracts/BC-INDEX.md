...
| BC-2.01.014 | Pure-Core 64-bit pcapng Timestamp Normalization to (ts_sec, ts_usecs) | P0 | [WRITTEN] | feature-pcapng-F2 | <!-- v1.5: greenfield; ADR-009 Decision 4; VP-025 Kani target; STORY-125; v1.1: saturating arithmetic, VP-025; v1.2: Kani unwind note, base-10 table note; v1.3: M-4 classic-pcap parity scoped to ts_high==0 (ts_high>0 saturates; classic stores raw u32 secs — not bitshift equivalent); v1.4: M-2 if_tsoffset declared out-of-scope — out-of-scope per ADR Decision 21; timestamp formula unchanged; v1.5: M-3 µs fast-path saturation gap fixed — PC4 if_tsresol=6 fast path rewrote ts_sec as (ticks/1_000_000).min(u32::MAX as u64) as u32; canonical large-ts_high saturation vector added; VP-025 Kani harness scope extended to cover if_tsresol=6 path with ts_high=u32::MAX; ADR-009 rev 8 -->
