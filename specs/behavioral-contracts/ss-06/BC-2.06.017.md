...
|--------|----------|-------------|
| VP-TBD | Poisoned request direction does not affect response parsing | unit: test_poison_request_does_not_affect_response |
...
| Architecture Module | SS-06 (analyzer/http.rs:509-523, C-14) |
| Stories | S-TBD |
