...
|--------|----------|-------------|
| VP-TBD | Poison state cleared after flow close and reopen | unit: test_poison_cleared_after_flow_close |
| VP-TBD | on_flow_close cleans up per-flow state | unit: test_flow_close_cleans_up_state |
...
| Architecture Module | SS-06 (analyzer/http.rs:540-542, C-14) |
| Stories | S-TBD |
...
- `src/analyzer/http.rs:540-542` -- on_flow_close implementation
...
| Property | Value |
|----------|-------|
| **Path** | `src/analyzer/http.rs:540-542` |
| **Confidence** | high |
