...
|--------|----------|-------------|
| VP-TBD | Raw bytes in URI flow through to Finding evidence | integration: test_http_finding_c1_csi_escaped_by_terminal_reporter |
...
| Architecture Module | SS-06 (analyzer/http.rs:70-75, C-14) |
| Stories | S-TBD |
