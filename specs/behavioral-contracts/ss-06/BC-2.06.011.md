...
|--------|----------|-------------|
| — | Empty UA emits Anomaly/Inconclusive/Low | unit: test_BC_2_06_011_detect_empty_user_agent |
| — | Absent UA emits no finding | unit: test_BC_2_06_011_missing_user_agent_no_finding |
