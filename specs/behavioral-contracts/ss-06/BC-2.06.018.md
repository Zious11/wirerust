...
|--------|----------|-------------|
| VP-TBD | non_http_flows counts per-flow, not per-direction | unit: test_non_http_flows_counts_per_flow_not_direction |
...
| Architecture Module | SS-06 (analyzer/http.rs:410-413, C-14) |
| Stories | S-TBD |
