...
|--------|----------|-------------|
| VP-TBD | Admin panel URI emits T1046 finding with Inconclusive/Low | unit: test_detect_admin_panel_paths |
...
| Architecture Module | SS-06 (analyzer/http.rs:235-249, C-14) |
| Stories | S-TBD |
