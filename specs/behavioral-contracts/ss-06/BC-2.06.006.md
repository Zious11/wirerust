...
modified:
  ...
  - "v1.3 (2026-05-28): F-W16-S042-P5-003 invariant-1 line-precise anchor prose added — shell_patterns array at http.rs:206-217; iter().any() guard at http.rs:218; finding push at http.rs:219-232; if-body closing `}` at http.rs:233 [pre-F2 lines; now :221-232/:233/:234-248/:248 post-F2]. Verified against src/analyzer/http.rs:206-233. Closes F-W16-S042-P5-003 (006 direction). — 2026-05-28"
  ...
  - "v1.6 (2026-06-13): P19-B-08 ss-06 line-anchor re-sync — shell_patterns array :206-217→:221-232; iter().any() guard :218→:233; finding push :219-232→:234-248; closing brace :233→:248; arch module/path :206-233→:220-248. Verified against current src/analyzer/http.rs (1044 lines)."
deprecated: null
deprecated_by: null
replacement: null
retired: null
...
1. URI comparison is case-insensitive (lowercased before pattern match). The `shell_patterns` array is defined at http.rs:221-232; the iter().any() guard is at http.rs:233; the finding push block spans http.rs:234-248; the if-body closing `}` is at http.rs:248.
...
| Architecture Module | SS-06 (analyzer/http.rs:220-248, C-12) |
| Stories | STORY-042 |
...
- `src/analyzer/http.rs:220-248` -- web shell detection block (shell_patterns array + finding push)
...
| Property | Value |
|----------|-------|
| **Path** | `src/analyzer/http.rs:220-248` |
| **Confidence** | high |
