...
|--------|----------|-------------|
| VP-TBD | Web-shell URI pattern emits T1505.003 finding | unit: test_detect_webshell_path |
| VP-TBD | Non-shell URI emits no web-shell finding | unit |
...
| Architecture Module | SS-06 (analyzer/http.rs:206-233, C-14) |
| Stories | S-TBD |
