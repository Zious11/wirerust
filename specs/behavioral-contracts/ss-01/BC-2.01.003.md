...
|--------|----------|-------------|
| — | packets.is_empty() == true for zero-packet pcap | unit test |
...
| Capability Anchor Justification | CAP-01 ("PCAP File Ingestion") per domain/capabilities/cap-01-pcap-ingestion.md -- this BC covers the degenerate zero-packet case of file ingestion |
