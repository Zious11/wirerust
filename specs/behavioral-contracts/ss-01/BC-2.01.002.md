...
|--------|----------|-------------|
| — | Packet count matches the number of pcap records | unit: craft pcap bytes, assert packets.len() |
| — | Timestamps are preserved without modification | unit: assert timestamp_secs and timestamp_usecs from known pcap |
