...
|--------|----------|-------------|
| VP-TBD | Non-ASCII UTF-8 SNI summary preserves raw Cyrillic (no Debug escaping) | unit: test_cyrillic_sni_emits_non_ascii_finding |
...
| Architecture Module | SS-07 (analyzer/tls.rs:449-467, C-16) |
| Stories | S-TBD |
