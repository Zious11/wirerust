...
|--------|----------|-------------|
| VP-TBD | Unknown cipher IDs render as 0xNNNN lowercase hex | unit (no dedicated test; format verified from code) |
...
| Architecture Module | SS-07 (analyzer/tls.rs:77-83, C-16) |
| Stories | S-TBD |
