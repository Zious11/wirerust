...
modified:
  ...
  - "v1.4: PG-ARP-F2-007 ss-07 full re-anchor — NonUtf8 finding construction 469-488→494-514; hex in extract_sni 261-264→262-265 — 2026-06-13"
deprecated: null
deprecated_by: null
replacement: null
retired: null
...
| Architecture Module | SS-07 (analyzer/tls.rs:494-514, C-13) |
| Stories | STORY-056 |
...
- `src/analyzer/tls.rs:494-514` -- NonUtf8 finding construction
- `src/analyzer/tls.rs:262-265` -- hex computed in extract_sni for NonUtf8
...
| Property | Value |
|----------|-------|
| **Path** | `src/analyzer/tls.rs:494-514` |
| **Confidence** | high |
