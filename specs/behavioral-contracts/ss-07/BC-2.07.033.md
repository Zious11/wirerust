...
|--------|----------|-------------|
| VP-TBD | Non-handshake records do not increment parse_errors | unit: test_stop_after_handshake exercises this (records after hellos are app data) |
...
| Architecture Module | SS-07 (analyzer/tls.rs:678-682, C-16) |
| Stories | S-TBD |
