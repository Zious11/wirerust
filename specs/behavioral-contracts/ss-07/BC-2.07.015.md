...
modified:
  ...
  - "v1.3: PG-ARP-F2-007 ss-07 full re-anchor — AsciiWithControl match arm 437-459→437-459 — 2026-06-13"
deprecated: null
deprecated_by: null
replacement: null
retired: null
...
| Capability Anchor Justification | CAP-07 ("TLS traffic analysis") per domain/capabilities/cap-07-tls-analysis.md -- this BC constrains the cardinality of SNI findings, a core TLS analysis property |
| L2 Domain Invariants | INV-5 (SNI 4-way classification), INV-4 (raw-data/display-layer separation) |
| Architecture Module | SS-07 (analyzer/tls.rs:437-459, C-13) |
| Stories | STORY-055 |
...
- `src/analyzer/tls.rs:437-459` -- AsciiWithControl match arm and single push

## Source Evidence

| Property | Value |
|----------|-------|
| **Path** | `src/analyzer/tls.rs:437-459` |
| **Confidence** | high |
