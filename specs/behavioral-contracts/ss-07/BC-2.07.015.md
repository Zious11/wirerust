...
|--------|----------|-------------|
| VP-TBD | Multiple control bytes produce exactly one finding | unit: test_multiple_control_bytes_in_sni_produces_single_finding |
...
| Architecture Module | SS-07 (analyzer/tls.rs:424-447, C-16) |
| Stories | S-TBD |
