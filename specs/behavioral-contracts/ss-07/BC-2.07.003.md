...
|--------|----------|-------------|
| VP-TBD | parse_errors stays 0 after application data post-done | unit: test_stop_after_handshake |
| VP-TBD | handshakes_seen not incremented by post-done ClientHello | unit: assert count after re-sending ClientHello bytes |
