...
|--------|----------|-------------|
| VP-TBD | Trailing bytes in ServerNameList do not cause error | unit: test_trailing_bytes_in_server_name_list |
...
| Architecture Module | SS-07 (analyzer/tls.rs:246-268, C-16) |
| Stories | S-TBD |
...
- `src/analyzer/tls.rs:246-268` -- extract_sni function (tls_parser handles the parse)
...
| Property | Value |
|----------|-------|
| **Path** | `src/analyzer/tls.rs:246-268` |
| **Confidence** | high |
