...
|--------|----------|-------------|
| VP-TBD | Weak client cipher produces exactly one finding | unit: test_weak_cipher_finding_client |
| VP-TBD | Strong ciphers produce no finding | unit: test_normal_handshake_no_findings |
