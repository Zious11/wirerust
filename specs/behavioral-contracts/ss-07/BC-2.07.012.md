...
|--------|----------|-------------|
| VP-TBD | Deprecated server version produces Anomaly/Likely/High finding | unit (no independent test; refactor-risk noted in R4 MEDIUM verdict) |
| VP-TBD | Direction is ServerToClient | unit assertion on finding.direction field |
