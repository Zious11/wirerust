...
|--------|----------|-------------|
| — | Non-zero NameType treated as hostname without rejection | unit: test_non_zero_name_type_sni_entry; test_non_zero_name_type_with_valid_first_entry |
...
| Capability Anchor Justification | CAP-07 ("TLS traffic analysis") per domain/capabilities/cap-07-tls-analysis.md -- NameType handling is an SNI edge case in TLS analysis |
...
- `src/analyzer/tls.rs:249-251` -- `let Some((_, hostname)) = list.first()` (NameType discarded)
