...
|--------|----------|-------------|
| VP-TBD | detail map contains exactly dns_queries and dns_responses keys | unit: assert detail keys == {"dns_queries", "dns_responses"} |
| VP-TBD | packets_analyzed == query_count + response_count | unit: test_dns_summarize |
