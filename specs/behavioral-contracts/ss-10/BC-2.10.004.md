...
|--------|----------|-------------|
| VP-TBD | No duplicates in all_tactics_in_report_order | unit: HashSet deduplication + len check |
| VP-TBD | All 16 variants are present | unit: iterate expected set, assert membership |
