...
|--------|----------|-------------|
| VP-TBD | Unknown ID returns None | unit: technique_name_returns_none_for_unknown_ids |
| VP-TBD | Lowercase form of known ID returns None | unit: assert None for "t1027" |
