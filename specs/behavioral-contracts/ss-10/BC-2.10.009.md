...
|--------|----------|-------------|
| — | MitreTactic has #[non_exhaustive] attribute | code: grep src/mitre.rs for non_exhaustive |
...
| Capability Anchor Justification | CAP-10 ("MITRE ATT&CK mapping") per domain/capabilities/cap-10-mitre-mapping.md -- #[non_exhaustive] is the extensibility contract for the MITRE tactic enum |
