...
|--------|----------|-------------|
| VP-017 | C0 bytes become backslash-uNNNN in JSON output | integration: test_output_sanitization_layering_contract |
| VP-017 | Round-trip recovers original bytes | integration: test_output_sanitization_layering_contract |
