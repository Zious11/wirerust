...
- `src/reporter/terminal.rs:185-207` -- FINDINGS dispatch block (flat vs grouped branch) where the collapse pass will be inserted (if !findings.is_empty() at :185; block close + out.push('\n') at :206-207)
