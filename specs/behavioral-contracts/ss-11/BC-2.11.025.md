...
| — | render.grouping == Grouping::Grouped suppresses the global flat-mode collapse pass (per-bucket collapse in grouped mode is governed by BC-2.11.031) | unit: test_BC_2_11_025_grouped_mode_bypasses_collapse |
