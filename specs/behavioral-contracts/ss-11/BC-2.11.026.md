...
| Stories | STORY-118, STORY-122 (A — preserves flat-mode (xN) suffix contract byte-identical), STORY-119 (B — references as flat analogue; grouped-collapse per-bucket suffix governed by BC-2.11.031) |
...
STORY-118, STORY-122 (A — preserves flat suffix contract), STORY-119 (B — flat analogue; grouped-collapse suffix in BC-031)
