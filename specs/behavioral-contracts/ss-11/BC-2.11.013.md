...
|--------|----------|-------------|
| VP-TBD | Tactic headers in canonical order | unit: mitre_grouping_emits_tactic_headers_in_canonical_order |
| VP-TBD | None/unknown bucket under Uncategorized | unit: mitre_grouping_buckets_none_and_unknown_under_uncategorized |
