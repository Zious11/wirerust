...
|--------|----------|-------------|
| VP-012 | Printable ASCII passes through | proptest: preserves_printable_ascii (terminal.rs) |
| VP-012 | Cyrillic passes through | proptest: preserves_cyrillic (terminal.rs) |
| VP-012 | Emoji passes through | proptest: preserves_emoji (terminal.rs) |
| VP-012 | Mixed content escapes only dangerous bytes | proptest: mixed_content_escapes_only_dangerous_bytes (terminal.rs) |
