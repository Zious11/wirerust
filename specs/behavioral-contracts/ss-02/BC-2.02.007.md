...
|--------|----------|-------------|
| VP-TBD | decode_packet never panics on arbitrary input | fuzz: cargo-fuzz target wrapping decode_packet |
| VP-TBD | All error paths return Err not panic | kani/manual: no unwrap in decode_packet |
