...
| Capability Anchor Justification | CAP-02 ("Link-type gating") per domain/capabilities/cap-02-link-type-gating.md -- the decode-layer link-type gate is the defense-in-depth complement to the reader-layer gate |
