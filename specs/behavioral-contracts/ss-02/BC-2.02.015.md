...
|--------|----------|-------------|
| VP-TBD | All 4 TCP flags extracted correctly | unit: build frames with each flag combination |
| VP-TBD | seq_number matches raw TCP header bytes | unit: compare with known-good frame |
