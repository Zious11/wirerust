...
|--------|----------|-------------|
| VP-TBD | Cache prevents repeated classification for same flow | unit: call on_data N times, verify classify called once |
...
| Architecture Module | SS-05 (dispatcher.rs:73-81, C-15) |
| Stories | S-TBD |
...
- `src/dispatcher.rs:73-81` -- routes.insert only when target != None

## Source Evidence

| Property | Value |
|----------|-------|
| **Path** | `src/dispatcher.rs:73-81` |
| **Confidence** | medium |
