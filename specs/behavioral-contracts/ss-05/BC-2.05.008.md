...
|--------|----------|-------------|
| VP-TBD | No-analyzer dispatcher returns early from on_data | unit: (inferred from dispatcher creation patterns in tests) |
...
| Architecture Module | SS-05 (dispatcher.rs:121-123, C-15) |
| Stories | S-TBD |
