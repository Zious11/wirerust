...
modified:
  ...
  - date: 2026-06-13
    actor: architect
    reason: "Pass-29 A-01: C-24 DNP3 HIGH-tier row technique set corrected — T1692.001 was omitted, leaving set as T1691.001/T0827/T0836/T0814. Full emitted set is T1692.001/T1691.001/T0814/T0836/T0827 (ADR-007 Decision 5; dnp3.rs lines 782/1092/1159 verified). Version bump 1.3→1.4."
  - date: 2026-06-23
    actor: product-owner
    reason: "F5 ICS tactic-ID correctness fix (D-209, DF-SIBLING-SWEEP-001): C-23 ARP row tactic annotation corrected — T0830 is IcsCollection (TA0100) NOT ICS LateralMovement (TA0008 is Enterprise LateralMovement). Research-validated per MITRE ATT&CK for ICS v19.1 (BC-2.10.007 v1.9 / BC-2.16.004 v1.8). FREEZE NOTE: this is a factual tactic-correctness update only; no architectural content changed. Version bump 1.4→1.5."
---
