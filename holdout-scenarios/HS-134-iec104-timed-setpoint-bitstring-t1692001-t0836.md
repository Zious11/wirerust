...
APCI: `68 12 00 00 00 00`; ASDU: TypeID=0x3D, VSQ=0x01, COT=0x0006, CASDU=0x0001,
...
APCI: `68 12 02 00 00 00`; ASDU: TypeID=0x3E, VSQ=0x01, COT=0x0006, CASDU=0x0001,
IOA=0x000065 (101), SVA=0x0064 (100), QOS=0x00, CP56Time2a=7 zero bytes.

**Frame C** — TypeID=63 (C_SE_TC_1, timed set-point short float):
APCI: `68 13 04 00 00 00`; ASDU: TypeID=0x3F, VSQ=0x01, COT=0x0006, CASDU=0x0001,
...
APCI: `68 12 06 00 00 00`; ASDU: TypeID=0x40, VSQ=0x01, COT=0x0006, CASDU=0x0001,
IOA=0x000067 (103), BSI=0xDEADBEEF (32 bits), QOS=0x00, CP56Time2a=7 zero bytes.
