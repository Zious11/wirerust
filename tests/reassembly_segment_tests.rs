...
fn test_insert_single_segment() {
    ...
    let result = dir.insert_segment(1001, b"hello", 10_485_760, 10_000);
...
fn test_flush_contiguous_single() {
    ...
    dir.insert_segment(1001, b"hello", 10_485_760, 10_000);
...
fn test_flush_contiguous_ordered() {
    ...
    dir.insert_segment(1001, b"aaa", 10_485_760, 10_000);
    dir.insert_segment(1004, b"bbb", 10_485_760, 10_000);
...
fn test_overlap_first_wins() {
    ...
    dir.insert_segment(1001, b"AAABBB", 10_485_760, 10_000);

    // Overlapping insert: "XXXCC" at offset 4 (overlaps with "BBB" at 4-6)
    let result = dir.insert_segment(1004, b"XXXCC", 10_485_760, 10_000);
...
fn test_overlap_conflicting_data_detected() {
    ...
    dir.insert_segment(1001, b"AAAA", 10_485_760, 10_000);

    // Same range, different data
    let result = dir.insert_segment(1001, b"BBBB", 10_485_760, 10_000);
...
fn test_sequence_wraparound() {
    ...
    dir.insert_segment(0xFFFF_FFF1, b"before", 10_485_760, 10_000);
    // Next segment wraps: seq = 0xFFFF_FFF1 + 6 = 0xFFFF_FFF7, offset = 7
    dir.insert_segment(0xFFFF_FFF7, b"wrap", 10_485_760, 10_000);
    // Another after wrap: seq = 0xFFFF_FFFB, offset = 11
    dir.insert_segment(0xFFFF_FFFB, b"around", 10_485_760, 10_000);
...
fn test_small_segment_tracking() {
    ...
    for i in 0..5u32 {
        let seq = 1001 + i;
        dir.insert_segment(seq, b"a", 10_485_760, 10_000);
    }
...
fn test_buffered_bytes_after_insert() {
    ...
    dir.insert_segment(1006, b"world", 10_485_760, 10_000);
...
fn test_buffered_bytes_after_overlap() {
    ...
    dir.insert_segment(1004, b"XXXCC", 10_485_760, 10_000);
...
fn test_buffered_bytes_partial_flush() {
    ...
    dir.insert_segment(1001, b"aaa", 10_485_760, 10_000);
    dir.insert_segment(1010, b"bbb", 10_485_760, 10_000);
    assert_eq!(dir.buffered_bytes, 6);
...
fn test_depth_limit_truncation() {
    ...
    let data = vec![b'A'; 80];
    dir.insert_segment(1001, &data, max_depth, 10_000);
    ...
    let result = dir.insert_segment(1081, &data2, max_depth, 10_000);
...
fn test_overlap_detection_boundary() {
    ...
    dir.insert_segment(1001, b"AAAAA", 10_485_760, 10_000);
    // Insert segment at offset 10, length 5 (covers 10-14) — no overlap with above
    dir.insert_segment(1010, b"BBBBB", 10_485_760, 10_000);
    ...
    let result = dir.insert_segment(1003, b"XXXX", 10_485_760, 10_000);
    assert_eq!(result, InsertResult::PartialOverlap);
    assert_eq!(dir.overlap_count, 1);
    ...
    let result = dir.insert_segment(1006, b"CCCC", 10_485_760, 10_000);
    assert_eq!(result, InsertResult::PartialOverlap);
...
fn test_range_boundary_exact_new_end() {
    ...
    let result = dir.insert_segment(1006, b"BBBBB", 10_485_760, 10_000);
    assert_eq!(result, InsertResult::Inserted);
    assert_eq!(dir.overlap_count, 0);
}
