...
pipeline: FEATURE
phase: F2
phase_status: "F2 adversary pass-8 CLEAN (0H/0C) — CLEAN-PASS 1/3 (BC-5.39.001); 3 MEDIUM remediated (M-1 SPB-fixed-min prose; M-2 HS-109 IDB holdout; M-3 BC-2.01.013 test-name); P8-001 metadata fix (HS-INDEX behavioral-subtleties 39→40; D-162); ADR-009 ACCEPTED; O-1 DEFERRED-TO-F3; adversary pass-9 pending (targeting clean-pass 2/3); trajectory 23/24/17/13/13/13/12/8; F3 BLOCKED until 3 consecutive clean passes"
product: wirerust
mode: brownfield
...
## Session Resume Checkpoint (2026-06-20 — F2 PASS-8 CLEAN (0H/0C) + FOCUSED RE-AUDIT CLEAN (P8-001 FIXED) — CLEAN-PASS 1/3 / PASS-9 PENDING / F3 BLOCKED)

**Previous checkpoint (F2 PASS-7 FULLY REMEDIATED + CONSISTENCY-VERIFIED (D-160) / PASS-8 PENDING / F3 BLOCKED) archived to:
`.factory/cycles/feature-pcapng-reader/session-checkpoints.md`**

### PIPELINE STATUS: FEATURE MODE — F2 PASS-8 CLEAN (0C/0H/3M/5L) — CLEAN-PASS 1/3 (BC-5.39.001); 3 MEDIUM REMEDIATED (M-1 SPB-FIXED-MIN PROSE; M-2 HS-109 IDB HOLDOUT; M-3 BC-2.01.013 TEST-NAME); P8-001 FIXED (D-162) — HS-INDEX v2.5 BEHAVIORAL-SUBTLETIES 39→40; FOCUSED RE-AUDIT CLEAN; ADR-009 ACCEPTED; O-1 DEFERRED-TO-F3; TRAJECTORY 23/24/17/13/13/13/12/8; PASS-9 PENDING (TARGETING CLEAN-PASS 2/3); F3 BLOCKED UNTIL 3 CONSECUTIVE CLEAN PASSES

Active cycle: **feature-pcapng-reader**. F2 pass-7 remediation COMPLETE (D-159)/re-audit COMPLETE (D-160). F2 pass-8 CLEAN (D-161): 0C/0H/3M/5L — CLEAN-PASS 1/3. M-1 (error-taxonomy v3.5 SPB-fixed-min prose); M-2 (HS-109 v1.0 IDB body-decode holdout, 5 cases; HS-INDEX v2.4 greenfield=109/all-namespace=182); M-3 (BC-2.01.013 v1.8 AC-001 test-name renamed, DF-AC-TEST-NAME-SYNC-001); O-2 (ADR-009 status=accepted); O-1 (framing-constant validator DEFERRED-TO-F3). Pass-8 focused re-audit CLEAN (D-162): FINDING-P8-001 FIXED — HS-INDEX v2.4→v2.5 behavioral-subtleties 39→40; CLEAN-PASS 1/3 confirmed (metadata fix does not reset counter). Trajectory 23/24/17/13/13/13/12/8. STORY-128 + STORY-127 scoped for F3. No in-flight story worktrees. No open PRs. **BEHAVIORAL DECISIONS TO SURFACE AT F2 HUMAN GATE: Decision 15 (interleaved-IDB reject → E-INP-013); Decision 16 (per-SHB reset dead-spec deferred); Decision 17 (IDB-parse precedence order); Decision 19 (zero-packet notice gating — amended rev 8: emission from main.rs, canonical format); Decision 20 (uniform block error-code rule); Decision 21 (if_tsoffset out-of-scope); Decision 22 (canonical spb_data_available=body.len()-4).**

### A. EXACT POSITION

- **Status:** FEATURE mode — pcapng reader cycle open. F2 adversarial reconvergence in progress (pass-8 CLEAN — D-161; clean-pass 1/3; adversary pass-9 pending). F3 BLOCKED until 3 consecutive clean passes.
...
- **Spec versions:** prd.md v1.33, error-taxonomy v3.5 (next_free E-INP-014; M-1 SPB-fixed-min prose), nfr-catalog v2.3, ADR-009 rev 9 (Decision 22: canonical spb_data_available=body.len()-4; HS-104 interface_id discriminant split; status=accepted), VP-INDEX v2.8 (total 31; unchanged), BC-INDEX v1.66, BC-2.01.009 v1.7, BC-2.01.010 v2.1, BC-2.01.011 v1.6, BC-2.01.012 v1.7, BC-2.01.013 v1.8, BC-2.01.014 v1.5, BC-2.01.015 v1.8, BC-2.01.016 v1.4, BC-2.01.017 v1.6, BC-2.01.018 v1.6, BC-2.12.011 v1.5, HS-103 v1.5, HS-104 v1.4, HS-107 v1.6, HS-108 v1.5, HS-109 v1.0 (NEW — IDB body-decode holdout), HS-INDEX v2.5 (greenfield=109; all-namespace=182; behavioral-subtleties=40), verification-architecture v2.4, verification-coverage-matrix v1.18. STORY-001 v1.6, epics.md v1.6, test-vectors v2.2.
...
**FEATURE MODE — pcapng reader cycle OPEN (feature-pcapng-reader). F2 PASS-8 CLEAN (D-161): 0C/0H/3M/5L — CLEAN-PASS 1/3 (BC-5.39.001). 3 MEDIUM remediated: M-1 (error-taxonomy v3.5 SPB-fixed-min prose); M-2 (HS-109 IDB body-decode holdout, 5 cases); M-3 (BC-2.01.013 v1.8 AC-001 test-name DF-AC-TEST-NAME-SYNC-001). P8-001 FIXED (D-162): HS-INDEX v2.5 behavioral-subtleties 39→40; focused re-audit CLEAN. ADR-009 ACCEPTED (O-2). O-1 (framing-constant validator) DEFERRED-TO-F3. TRAJECTORY 23/24/17/13/13/13/12/8. F3 BLOCKED — 2 more consecutive clean passes required. Adversary pass-9 pending.**
