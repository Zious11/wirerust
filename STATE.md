...
dropped from BC-INDEX (D-01 P22). Future PRD/BC-INDEX bumps will not create new version-lag
findings. Remaining LOW churn is cosmetic; sustained 0-CRIT/HIGH for 5 passes.
