...
**FEATURE MODE — pcapng reader cycle OPEN (feature-pcapng-reader). F2 REMEDIATION APPLIED. F3 BLOCKED — adversarial reconvergence (3 clean passes) required. Pass 2 not yet dispatched.**
