...
phase: F3
phase_status: "F3 COMPLETE. Adv-story Pass 1: FAIL (4C/6H/5M/3obs) REMEDIATED. Pass 2: FAIL (1C/3H/5M/3L) REMEDIATED. Pass 3: FAIL (0C/2H/3M/2L) REMEDIATED. Pass 4: FAIL (2C/2H/2M) ALL REMEDIATED. Pass 5: FAIL (0C/1H/2M) — F5-001..F5-003 ALL REMEDIATED (STORY-137 carry-overflow T0814 ordering, STORY-130 VP-032 Sub-A asserts, canonical harness names). Trajectory: 4C/6H→1C/3H→0C/2H→2C/2H→0C/1H. Convergence counter: 0/3 (reset). Pass 6 running."
product: wirerust
mode: feature-mode
...
**PIPELINE FEATURE-MODE. Cycle `feature-enip-v0.11.0` OPEN. F1 PASSED. F2 COMPLETE (human gate D-230). F3 COMPLETE + CONSISTENCY FIXES APPLIED: 9 stories STORY-130..138 (E-20, waves 58-61, 66 pts; all 26 BC-2.17.001..026 covered) + 13 holdout scenarios HS-110..122 (all must-pass). F3 ADV-STORY PASS 1: FAIL (4C/6H/5M/3obs) REMEDIATED. PASS 2: FAIL (1C/3H/5M/3L) REMEDIATED. PASS 3: FAIL (0C/2H/3M/2L) REMEDIATED. PASS 4: FAIL (2C/2H/2M) ALL REMEDIATED. PASS 5: FAIL (0C/1H/2M) ALL REMEDIATED (F5-001 STORY-137 carry-overflow T0814 ordering, F5-002 STORY-130 VP-032 Sub-A asserts, F5-003 STORY-130 canonical harness names). Severity trajectory: 4C/6H→1C/3H→0C/2H→2C/2H→0C/1H. Convergence counter: 0/3 (reset). Pass 6 running. ENGINE-PROPAGATION-GREP-GATE-001 in OPEN ITEMS.**
...
| Feature EtherNet/IP + CIP (issue #316) — v0.11.0 | **F3 COMPLETE — ADV-STORY PASS 5 FAIL (0C/1H/2M) ALL REMEDIATED — PASS 6 RUNNING** | F3: stories STORY-130..138 (9, E-20, 66 pts) + holdout HS-110..122 (13). Consistency audit: 2C/1M/1L REMEDIATED. Pass 1-4: REMEDIATED. Pass 5: FAIL (0C/1H/2M) REMEDIATED (F5-001 STORY-137 carry-overflow T0814 ordering, F5-002/003 STORY-130 VP-032 Sub-A asserts + harness names). Trajectory: 4C/6H→1C/3H→0C/2H→2C/2H→0C/1H. Convergence counter: 0/3 (reset). Pass 6 running. Detail: cycles/feature-enip-v0.11.0/ |
