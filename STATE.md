...
phase_status: "F2-adversarial-convergence 0/3 — STRICT WHOLE-CORPUS (human-elected 2026-06-13); 11 passes; corpus-wide sweep in progress"
...
arp_f2_convergence_trajectory: "15→20→~8→~15→~6→~4→~4→~7→~4→~6→~5 — 0/3 STRICT WHOLE-CORPUS; 11 passes; ARP delta SETTLED; corpus-wide sweep in progress. Detail: phase-f5-adversarial/arp-f2-convergence-trajectory.md"
...
**wirerust v0.6.0 RELEASED (DNP3 TCP analyzer, issue #8). Feature: ARP security analyzer + etherparse 0.16→0.20.1 migration (F1 PASSED 2026-06-12); release target v0.7.0. F2 spec evolution IN PROGRESS — adversarial convergence 0/3 STRICT WHOLE-CORPUS mode (human-elected 2026-06-13; 11 passes; ARP delta SETTLED; corpus-wide sweep in progress; trajectory 15→20→~8→~15→~6→~4→~4→~7→~4→~6→~5).**
...
| Feature: ARP analyzer — F2 Spec Evolution | **IN PROGRESS** — adversarial convergence 0/3 STRICT WHOLE-CORPUS mode (human-elected 2026-06-13) | SLICED 4-slice method; 11 passes; ARP delta SETTLED; corpus-wide sweep in progress; trajectory 15→20→~8→~15→~6→~4→~4→~7→~4→~6→~5; 283 BCs; artifact versions updated through Pass-11 (ADR-008 v1.8, arch-delta v1.10, PRD v1.15, BC-INDEX v1.16, BC-2.02.009 v1.6, BC-2.16.014 v1.6, cap-10 v1.7, test-vectors v1.9); trajectory: `phase-f5-adversarial/arp-f2-convergence-trajectory.md` |
