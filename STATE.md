...
phase: feature-f3
phase_status: "v0.7.1 RELEASED + maint-2026-06-17 COMPLETE + reactive fix #220 CLOSED (PR #263 merged; develop 5ed8077). Feature #259 (finding-collapse) F2 SPEC EVOLUTION CONVERGED — adversarial gate SATISFIED 3/3 (Passes 15/16/17 clean in parallel on frozen corpus 4231b6b; each zero MEDIUM-or-above). 17 passes total. NEXT = F3 story decomposition (STORY-118 flat collapse v0.8.0; STORY-119 grouped deferred)."
...
**Step 4 — NEXT ACTIONS:**
- Dispatch F3 story decomposition: STORY-118 (flat collapse v0.8.0); STORY-119 (grouped-mode collapse) deferred per OQ-3.
