...
## Session Resume Checkpoint (2026-06-20 — F2 PASS-8 CLEAN (0H/0C) — CLEAN-PASS 1/3 / PASS-9 PENDING / F3 BLOCKED)
...
- **Spec versions:** prd.md v1.33, error-taxonomy v3.5 (next_free E-INP-014; M-1 SPB-fixed-min prose), nfr-catalog v2.3, ADR-009 rev 9 (Decision 22: canonical spb_data_available=body.len()-4; HS-104 interface_id discriminant split; status=accepted), VP-INDEX v2.8 (total 31; unchanged), BC-INDEX v1.66, BC-2.01.009 v1.7, BC-2.01.010 v2.1, BC-2.01.011 v1.6, BC-2.01.012 v1.7, BC-2.01.013 v1.8, BC-2.01.014 v1.5, BC-2.01.015 v1.8, BC-2.01.016 v1.4, BC-2.01.017 v1.6, BC-2.01.018 v1.6, BC-2.12.011 v1.5, HS-103 v1.5, HS-104 v1.4, HS-107 v1.6, HS-108 v1.5, HS-109 v1.0 (NEW — IDB body-decode holdout), HS-INDEX v2.4 (greenfield=109; all-namespace=182), verification-architecture v2.4, verification-coverage-matrix v1.18. STORY-001 v1.6, epics.md v1.6, test-vectors v2.2.
