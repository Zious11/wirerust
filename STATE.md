...
| GREEN-DOC-TENSE-GATE-COVERAGE-001 | bin/check-green-doc-tense gate strengthened during STORY-135 convergence (patterns 12-22 added): now catches feature-enip RED phrasings + "before reaching todo!()" forms. RESOLVED — ships with STORY-135 PR. Residual: assert!/assert_eq! message string literals and doc-comment test-name backtick refs still not scanned — deferred to cycle close per S-7.02. | RESOLVED (gate strengthened, ships with STORY-135 PR) — residual assert-message/test-name-backtick scan DEFERRED cycle close |
