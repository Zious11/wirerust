...
| File | AC | Summary |
|------|----|---------|
| [AC-164-001.md](AC-164-001.md) | AC-164-001 | STORY-INDEX status-vocabulary legend at lines 124–145: six statuses, synonym note, loci agreement rule |
...
|----|-------------|--------|
| AC-164-001 | `sed -n '124,145p'` shows legend with all six statuses, synonym note, loci agreement rule | PASS |
